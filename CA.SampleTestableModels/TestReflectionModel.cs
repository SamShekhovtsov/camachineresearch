...
namespace CA.SampleTestableModels
{
    public unsafe class TestReflectionModel : ITestableModel
    {
        // Fields
        ...
        public string Name
        {
            get { return "Test Reflection Model"; }
        }
        ...
        public void Test(ref IntPtr Dim0, ref IntPtr Dim1, ref IntPtr Dim2, ref IntPtr Dim3, ref IntPtr Dim4, ref IntPtr Dim5, ref IntPtr Dim6, ref IntPtr Dim7, ref IntPtr Dim8, ref IntPtr Dim9, ref IntPtr Dim10, int iterationsCount, int height, int width, IntPtr SdlScreenPixelBuffer, IntPtr colors)
        {
            height_1 = height - 1;
            width_1 = width - 1;
        ...
        {
            return "Test Reflection Model description";
        }
    }
}
